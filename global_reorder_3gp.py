...
import time
from utils import solve_QUBO, checkBalance, makePermutation, print_graph, calculateSWAP, select_circuit
...
def main():
    ...
    if dToffoli:
        ...
        nq = 6 # total number of qubits (+2 additional qubits)
